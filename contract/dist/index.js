...
export const GuestbookContractInstance = CompiledContract.make("Guestbook", (CompiledGuestbookContract.Contract)).pipe(CompiledContract.withWitnesses(Witnesses.witnesses), CompiledContract.withCompiledFileAssets("./managed/guestbook"));
/**
